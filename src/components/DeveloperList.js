...
export const DeveloperList = ({ config }) => {
    ...
    const sendRequest = async (name) => {
        ...
        const data = {
            ...
            "header": 'I want to work with developer/designer ' + name
        }
                            ...
                            <div className="col-sm-6 col-md-6 col-lg-3 col-xs-8 fade-in" key={"fenomen-" + v.key}>
                                <div className='fenomen-card bx-shadow flex-rw p-anim fade-in'>
                                    ...
                                    <div className="fenomen-request flex">
                                        <button className='outline-reset bx-shadow' disabled={onSbmt} onClick={() => sendRequest(v.name)}>{onSbmt ? <Spinner animation="border" /> : v.button}</button>
                                    </div>
                                </div>
                            </div>
                        );
